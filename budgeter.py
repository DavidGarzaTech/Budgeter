...
class Window1:
    def __init__(self, master):
        ...
        Label( self.frame, bg = "white",text = "BUDGETER" ,font="ariel", height = 3, width = 20).grid(row = 0, column= 0)
        ...
        Button(self.frame, height=3, width=7,bg="white", text="show db",command=self.show ).grid(row=6,columnspan=2)
...
class Register:
    def __init__(self, master):
        ...
        self.notebook = ttk.Notebook(self.master)
        self.user_info_frame = Frame(self.notebook)
        self.user_info_frame.pack(fill= "both", expand=1)
        
        self.user_lFrame = LabelFrame(self.user_info_frame)
        self.user_lFrame.pack()
        
        
        
        first_name_label = Label(self.user_lFrame, text = "First Name")
        last_name_label = Label(self.user_lFrame,text = "Last Name")
        pronouns_label = Label(self.user_lFrame, text = "Pronouns")
        self.pronouns = ttk.Combobox(self.user_lFrame, values =["He", "Her", "They"])
        self.first_name_entry = Entry(self.user_lFrame)
        self.last_name_entry = Entry (self.user_lFrame)
        Label(self.user_lFrame, text = "Age")
        self.age = Spinbox(self.user_lFrame, from_= 18 , to=100)
        ...
        Label(self.user_finance_info, text="Enter your monthly income" ).grid(row =3 , column=0 )
